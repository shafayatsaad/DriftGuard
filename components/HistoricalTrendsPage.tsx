      ...
      <div className="flex flex-col md:flex-row items-center justify-between bg-[#16213e] p-4 rounded-xl border border-gray-800 shadow-lg mb-6 gap-4">
        <div className="flex items-center space-x-4 w-full md:w-auto overflow-x-auto">
          <div className="relative">
            <button className="flex items-center space-x-2 bg-[#1a1a2e] border border-gray-700 hover:border-[#0f4c75] px-4 py-2 rounded-md text-sm text-gray-300 w-48 justify-between">
              <span className="flex items-center"><Calendar className="w-4 h-4 mr-2" /> {dateRange}</span>
              <ChevronDown className="w-4 h-4" />
            </button>
          </div>
          <div className="relative">
            <button className="flex items-center space-x-2 bg-[#1a1a2e] border border-gray-700 hover:border-[#0f4c75] px-4 py-2 rounded-md text-sm text-gray-300">
          ...
          <div className="relative hidden lg:block">
            <button className="flex items-center space-x-2 bg-[#1a1a2e] border border-gray-700 hover:border-[#0f4c75] px-4 py-2 rounded-md text-sm text-gray-300">
              <span>Compare: Baseline (Jan 1)</span>
              <ChevronDown className="w-4 h-4 ml-2" />
            </button>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3">
          ...
          <button className="flex items-center space-x-2 bg-[#0f4c75] hover:bg-[#165a8a] text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
