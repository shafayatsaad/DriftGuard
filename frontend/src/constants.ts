...
export const TOP_DRIFTING_FEATURES: DriftFeature[] = [
  { name: "income", psi: 0.45, ks: 0.32, kl: 0.18, status: "critical" },
  { name: "age", psi: 0.28, ks: 0.21, kl: 0.12, status: "warning" },
  {
  ...
  { name: "credit_score", psi: 0.19, ks: 0.15, kl: 0.07, status: "warning" },
  { name: "debt_ratio", psi: 0.15, ks: 0.12, kl: 0.05, status: "good" },
];

// Generate 30 days of data with a downward trend at the end
export const PERFORMANCE_DATA: PerformanceDataPoint[] = Array.from(
  { length: 30 },
  (_, i) => {
    const day = i + 1;
    let baseAccuracy = 95;
